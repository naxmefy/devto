...
class ArticleCreateArticle {
  ...
  @override
  String toString() {
    return 'ArticleCreateArticle[title=$title, bodyMarkdown=$bodyMarkdown, published=$published, series=$series, mainImage=$mainImage, canonicalUrl=$canonicalUrl, description=$description, tags=$tags, organizationId=$organizationId, ]';
  }

  ArticleCreateArticle.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    title = json['title'];
  ...
  static List<ArticleCreateArticle> listFromJson(List<dynamic> json) {
    return json == null ? List<ArticleCreateArticle>() : json.map((value) => ArticleCreateArticle.fromJson(value)).toList();
  }

  static Map<String, ArticleCreateArticle> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, ArticleCreateArticle>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = ArticleCreateArticle.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ArticleCreateArticle-objects as value to a dart map
  static Map<String, List<ArticleCreateArticle>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<ArticleCreateArticle>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = ArticleCreateArticle.listFromJson(value);
       });
     }
     return map;
  }
